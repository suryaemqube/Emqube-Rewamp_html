...
const Layout = ({ children, isHome, isMainParent, isChild, isMobileAppChild, isAiDevChild, isWhatsappBusChild, isBusinessIntelChild, isECommerceChild, isZoho, about, isRef, isSftProj, isPortDetail, isEmqonnectList, isEmqonnectDetail, isDigiProj, isContact, isThankyou, isChat, isCmnPage }) => {
  ...
  return (
    <>
      ...
      <main className={`
        ...
        ${isCmnPage ? "inside-page common-page" : ""}
        `}>
