...
export default function EmqonnectDetail({ data }) {

  const emqoPost = data.wpBlog;

   // exclude current post and take 3
  const latestPosts = data?.allWpBlog?.nodes
    ?.filter(p => p.id !== emqoPost?.id)
    .slice(0, 3) || [];

  // trim content helper
  const trimContent = (html, wordLimit = 30) => {
    if (!html) return "";
  ...
  const pageTitle = encodeURIComponent(emqoPost?.title || "");
  const encodedUrl = encodeURIComponent(pageUrl);

  const shareLinks = {
    facebook: `https://www.facebook.com/sharer/sharer.php?u=${encodedUrl}`,
    twitter: `https://twitter.com/intent/tweet?url=${encodedUrl}&text=${pageTitle}`,
      ...
      <section className="inside-intro-wrapper inside-child-intro-wrapper">
        <div class="container">
          ...
          <div className="breadcrumbs">
            <span><a href="/">Home</a></span>
            <span><span className="seperate"> &gt; </span><a href="/emqonnect/">emQonnect</a></span>
            <span><span className="seperate"> &gt; </span><span className="post post-page current-item"
      ...
      <section className="emqonnect-detail-wrapper">
        <div className="container">
          <div className="blog-detail-content">
            <p className="date">{emqoPost?.date}</p>
            ...
            {emqoPost?.content && 
              <div className="blog-detail-txt" dangerouslySetInnerHTML={{__html: emqoPost.content}} />
            }
          ...
          <div className="container">
            ...
            <div className="emqonnect-list">
              ...
              <div className="view-all-btn">
                <Link to="/emqonnect/" className="view-all">
