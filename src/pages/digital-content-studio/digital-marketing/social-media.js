...
export const Head = ({ data }) => {
  const schema = {
    ...
    "@type": "Service",
    "name": "Social Media Management Services Dubai",
    "description": "Build a loyal community with practical, consistent, and engaging social media management on Instagram, LinkedIn, and TikTok.",
    ...
    "serviceOutput": "Monthly Content Calendars, Reels, Posts & Performance Reports"
  };
  return (
    <>
