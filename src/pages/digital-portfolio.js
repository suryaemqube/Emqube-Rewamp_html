...
const Header = () => {
  ...
  const socialPosts = [
    { id: 1, src: "/assets/img/cc-social-media-thumb.webp", link: "https://www.instagram.com/corporateconnectionsuae/" },
    { id: 2, src: "/assets/img/emovers-social-media-thumb-v1.webp", link: "https://www.instagram.com/emoversuae/" },
    { id: 3, src: "/assets/img/tamam-social-media-thumb-v1.webp", link: "https://www.instagram.com/tamammovers/" },
    { id: 4, src: "/assets/img/tld-social-media-v1.webp", link: "https://www.instagram.com/tamammovers/" },
    { id: 5, src: "/assets/img/electricway-social-media-thumb-v1.webp", link: "https://www.instagram.com/electric_way/" },
  ];

  const emailers = [
    { id: 1, 
      thumb: "/assets/img/TLD-mailer.webp", 
      gallery: [
        "/assets/img/TLD-mailer.webp",
        "/assets/img/Emovers-mailer.webp",
        "/assets/img/TLD-mailer.webp",
        "/assets/img/Emovers-mailer.webp",
      ],
    },
    { id: 2, 
      thumb: "/assets/img/Emovers-mailer.webp", 
      gallery: [
        "/assets/img/Emovers-mailer.webp",
        "/assets/img/Emovers-mailer.webp",
      ],
    ...
    { id: 3, 
      thumb: "/assets/img/Insurance-policy-mailer.webp", 
      gallery: [
        "/assets/img/Insurance-policy-mailer.webp",
        "/assets/img/Emovers-mailer.webp",
        "/assets/img/Insurance-policy-mailer.webp",
      ], 
    },
    { id: 4, 
      thumb: "/assets/img/Homework-mailer.webp", 
      gallery: [
        "/assets/img/Homework-mailer.webp",
        "/assets/img/Emovers-mailer.webp",
        "/assets/img/TLD-mailer.webp",
        "/assets/img/Emovers-mailer.webp",
      ],
    ...
    { id: 5, 
      thumb: "/assets/img/Tamam-mailer-1.webp", 
      gallery: [
        "/assets/img/Tamam-mailer-1.webp",
        "/assets/img/Emovers-mailer.webp",
        "/assets/img/TLD-mailer.webp",
        "/assets/img/Emovers-mailer.webp",
      ], 
  ...
  const digitalMedia = [
    { id: 1, src: "/assets/img/digital-media-saion.png",
      pdf: "/assets/pdf/sample.pdf",
      text: (
        <>
          <p className="title">Saion Properties</p>
          <p className="txt">Coffee table book commemorating the conglomerate’s 50th anniversary and legacy</p>
        </>
      ),
      tag: "brochure" 
    },
    { id: 2, src: "/assets/img/digital-media-bridgeway.png",
      pdf: "/assets/pdf/sample.pdf",
      text: (
        <>
          <p className="title">Saion Properties</p>
    ...
    { id: 3, src: "/assets/img/digital-media-tamam.png",
      text: (
        <>
          <p className="title">Saion Properties</p>
          <p className="txt">Coffee table book commemorating the conglomerate’s 50th anniversary and legacy</p>
    ...
    { id: 4, src: "/assets/img/digital-media-saion.png",
      pdf: "/assets/pdf/sample.pdf",
      text: (
        <>
          <p className="title">Saion Properties</p>
    ...
    { id: 5, src: "/assets/img/digital-media-bridgeway.png",
      pdf: "/assets/pdf/sample.pdf",
      text: (
        <>
          <p className="title">Saion Properties</p>
    ...
    { id: 6, src: "/assets/img/digital-media-tamam.png",
      text: (
        <>
          <p className="title">Saion Properties</p>
          <p className="txt">Coffee table book commemorating the conglomerate’s 50th anniversary and legacy</p>
  ...
  const corpVid = [
    { id: 1, vidId: "p8GYcNjX-Ss" },
    { id: 2, vidId: "S4VjAXbIKIY" },
    { id: 3, vidId: "x9g81gGfd80" },
    { id: 4, vidId: "p8GYcNjX-Ss" },
    { id: 5, vidId: "S4VjAXbIKIY" },
    { id: 6, vidId: "x9g81gGfd80" },
  ];
            ...
            <ul>
              <li>
                <a href="#">
                  <div className="desk-view">
                    <img src="/assets/img/emovers-digital-portfolio.webp"></img>
                    <div className="hover-txt">
                      <p>Region's largest relocation company with services for furniture installation and storage</p>
                    </div>
                  </div>
                  <div className="mob-view">
                    <img src="/assets/img/emovers-digi-mob.webp" className="hover-mob-view-hide"></img>
                    <img src="/assets/img/emovers-desktop-view.png" className="hover-desk-view-show"></img>
                  </div>
              ...
              <li>
                <a href="#">
                  ...
                  <div className="mob-view">
                    <img src="/assets/img/emovers-digi-mob.webp"></img>
                  </div>
                  <div className="client-icon">
                    <img src="/assets/img/emovers-new-logo.webp" alt="Emovers logo"></img>
                  </div>
          ...
          <div className="digi-proj-list">
            ...
            >
              {socialPosts.map((socialpost, index) => (
                <SwiperSlide key={index}>
                  <a href={socialpost.link} target="_blank">
                    <img src={socialpost.src}></img>
                  </a>
                </SwiperSlide>
              ))}
            </Swiper>
              ...
              {emailers.map((item, index) => (
                <SwiperSlide key={index}>
                  <LightGallery
                    ...
                    selector={"li"}
                  >
                    <ul className="design-gallery" id="Gal">
                      {/* {emailers.map((item, i) => */}
        ...
        <div className="container">
          ...
          <div className="digi-proj-list">
            <Swiper
              ...
              navigation={true}
              // navigation={{
              //   prevEl: ".digiMedia-prev",
              //   nextEl: ".digiMedia-next",
              // }}
              breakpoints={{
                0: { 
                  slidesPerView: 1,
            ...
            >
              {digitalMedia.map((digiMedia, index) => (
                <SwiperSlide key={index} className={digiMedia.tag}>
                  {digiMedia.tag == "brochure" && (
                    <a href={digiMedia.pdf} target="_blank" rel="noopener noreferrer">
                      <>
                        <div className="digiMedia-img">
                          <span className={digiMedia.tag}></span>
                          <img src={digiMedia.src}></img>
                        </div>
            ...
            {/* <div class="swiper-button-prev digiMedia-prev">
            ...
            <div class="swiper-button-next digiMedia-next">
              <svg class="swiper-navigation-icon" width="11" height="20" viewBox="0 0 11 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0.38296 20.0762C0.111788 19.805 0.111788 19.3654 0.38296 19.0942L9.19758 10.2796L0.38296 1.46497C0.111788 1.19379 0.111788 0.754138 0.38296 0.482966C0.654131 0.211794 1.09379 0.211794 1.36496 0.482966L10.4341 9.55214C10.8359 9.9539 10.8359 10.6053 10.4341 11.007L1.36496 20.0762C1.09379 20.3474 0.654131 20.3474 0.38296 20.0762Z" fill="currentColor"></path></svg>
            </div> */}
          </div>
        </div>
      ...
      <section className="digi-portfolio-wrapper" id="corpVid">
        <div className="container">
          ...
          <div className="digi-proj-list">
            ...
            >
              {corpVid.map((corpVideo, index) => (
                <SwiperSlide key={index}>
                  <div key={corpVideo.id} className="video-item">
                    <iframe width="560" height="315" src={`https://www.youtube.com/embed/${corpVideo.vidId}?si=mE7iURV9KHd8wGC7`} title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                  </div>
                </SwiperSlide>
              ))}
            </Swiper>
...
export default function Home() {
  return (
    <main className="inside-page inside-child digi-portfolio">
      <Header />
    </main>
  );
}