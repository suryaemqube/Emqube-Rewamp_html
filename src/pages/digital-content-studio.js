...
export default function SoftwareSolMain({ data }) {
  ...
  const webSlides1 = softSolMain?.spPages?.map((softItem1, index) => ({
  ...
  const webSlides2 = softSolMain?.scPages?.map((softItem2, index) => ({
  ...
  const logos = softSolMain?.platforms.map(item => ({
  ...
  return (
    ...
    <>
        ...
        <section className="inside-intro-wrapper">
          <div className="container">
            <div className="inside-intro-count left">
              <ul className="d-flex">
                {softSolMain?.statsLeft.map((statLeft, index) => (
                  <li 
                  className={` ${index === 0 ? "bg-green" : ""} ${index === 1 ? "bg-white" : ""}`} 
                  dangerouslySetInnerHTML={{__html: statLeft.statContent}}
                  />
                ))
                }
              </ul>
            ...
            <div className="inside-intro-count right">
              <ul className="d-flex">
                {softSolMain?.statsLeftCopy.map((statRight, index) => (
                  <li 
        ...
        <section className="home-choose-wrapper inside-choose-wrapper">
          <div className="container">
            ...
            <div className="home-why-choose-list">
              <ul className="d-flex">
                {softSolMain?.wcuContent.map((softChoose, index) => (
        ...
        <section className="engagement-model-wrapp parent-eng-model">
          <div className="container">
            ...
            <div className="eng-model-step">
              <ul>
                {softSolMain?.emSteps && softSolMain?.emSteps.map((engStep, index) => (
                  <li className="stagger-li">
      ...
      {softSolMain?.technologyPlatformText && softSolMain?.technologyPlatformTitle && 
        <section className="brand-wrapper digital-plaform-wrapper">
          <div className="container">
            <h2 className="txt-center txt-gradient slide-up" dangerouslySetInnerHTML={{__html: softSolMain?.technologyPlatformTitle}} />
            <p className="txt-center" dangerouslySetInnerHTML={{__html: softSolMain?.technologyPlatformText}} />
            <ul className="brand-list d-flex slide-up">
              {(isMobile ? logos.slice(0, visibleCount) : logos).map((logo, index) => (
                <li key={index}>
                  <a href="#">
                    <img src={logo.src} width="148" height="72" alt={logo.alt} />
                    <p className="platform-name">{logo.alt}</p>
                  </a>
                </li>
              ))}
            </ul>
  ...
  query MyQuery {
    wpPage(databaseId: {eq: 139}) {
      ...
      digitalContentStudioLp {
        ...
        technologyPlatformText
        technologyPlatformTitle
        platforms {
          altText
          mediaItemUrl
        }
