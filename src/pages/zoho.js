        ...
        <div class="container">
          ...
          <div className="product-head-wrapper">
            <div className="left">
              ...
              <p className="sub-txt">Maximise the complete value of your customer life cycle</p>
            </div>
            <div className="right">
                      ...
                      <ul>
                        <li>
                          <span class="wpcf7-form-control-wrap" data-name="company-name">
                            <input size="40" maxlength="400" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Company Name" value="" type="text" name="company-name">
                          </span></li>
                        <li>
                          <span class="wpcf7-form-control-wrap" data-name="company-name">
                            <input size="40" maxlength="400" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Company Name" value="" type="text" name="company-name">
                        ...
                        <li>
                          <span class="wpcf7-form-control-wrap" data-name="employee">
                            <input size="40" maxlength="400" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Number of employees" value="" type="text" name="employee">
                          </span>
                        </li>
