              ...
              <li key={index}>
                ...
                <a href={`/software-projects/${project.slug}/`}>
                  <div className="proj-main-img">
                    ...
                    <img
                      src={
                        project?.softwarePortfolioLayout
                          ?.projectListingPageImage?.mediaItemUrl
                      }
                      alt={
                        project?.softwarePortfolioLayout
                          ?.projectListingPageImage?.altText
                      }
                    />

                    <p
                      className="proj-main-title"
