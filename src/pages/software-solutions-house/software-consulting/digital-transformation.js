        ...
        <section className="strategic-choice-wrapper">
          <div className="container">
            ...
            <div className="module-list">
              <h3 className="txt-center">Digital Transformation Journey</h3>
              <ul>
...
export const Head = ({ data }) => {
  const schema = {
    ...
    "@type": "Service",
    "name": "Digital Transformation Consulting Services Dubai",
    "description": "Modernize your business operations with emQube's digital transformation consulting. Start, scale, and sustain your growth.",
    ...
    "serviceOutput": "Digital Roadmap, Process Automation & System Modernization"
  };
  return (
    <>
