...
export default function SftProduct({ data }) {
  ...
  return (
    ...
    <>
      ...
      {softProductChild?.zohoWhyPartnerSectionTitle && softProductChild?.zohoWhyPartnerSectionText && 
...
export const Head = ({ data }) => {
  const schema = {
    ...
    "@type": "Service",
    "name": "135-Todo Task Management & Daily Planner Software",
    "description": "Maximize team productivity with 135-Todo. Our task management software uses the proven 1-3-5 method to prioritize workflows.",
    "url": "https://emqube.com/software-solutions-house/software-products/productivity-135/",
    "provider": { "@type": "Organization", "name": "emQube", "url": "https://emqube.com" },
    "areaServed": { "@type": "Country", "name": "United Arab Emirates" },
    "serviceType": "Productivity & Task Management Software",
    "serviceOutput": "135-Todo Daily Planner with Team Dashboards & Time Tracking"
  };
  return (
    <>
