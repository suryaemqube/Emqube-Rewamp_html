...
export const Head = ({ data }) => {
  const schema = {
    ...
    "@type": "Service",
    "name": "CAFM Pro | Facility Management Software Dubai",
    "description": "Optimize your property and asset management with CAFM Pro, our browser-based facility management software in Dubai.",
    "url": "https://emqube.com/software-solutions-house/software-products/fm-cafm-pro/",
    "provider": { "@type": "Organization", "name": "emQube", "url": "https://emqube.com" },
    "areaServed": { "@type": "Country", "name": "United Arab Emirates" },
    "serviceType": "Facility Management Software",
    "serviceOutput": "CAFM Pro — Browser-Based FM System with Power BI Reporting"
  };
  return (
    <>
