...
export const Head = ({ data }) => {
  const schema = {
    ...
    "@type": "Service",
    "name": "AI Development & Agentic Solutions Dubai",
    "description": "Automate complex processes by integrating secure AI agents and enterprise LLMs into your existing ERP and CRM systems.",
    ...
    "serviceType": "AI & Generative AI Development",
    "serviceOutput": "AI Agents, Chatbots & LLM Integrations"
  };
  return (
    <>
