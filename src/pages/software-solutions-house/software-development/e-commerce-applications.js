...
export default function SoftwareSolChild({ data }) {
  ...
  const itemPartCount = softSolChild?.wpwContent?.length || 0;
  ...
  return (
    ...
    <>
      ...
      {softSolChild?.wpTitle && softSolChild?.wpwContent && 
        <section className={`inside-partner-wrapper partner-${itemPartCount}`}>
          <div className="container">
