...
export const Head = ({ data }) => {
  const schema = {
    ...
    "description": "Create high-performance native, hybrid, and progressive web apps (PWAs) tailored to your mobility goals with emQube.",
    ...
    "serviceOutput": "iOS, Android & Hybrid Mobile Applications"
  };
  return (
    <>
